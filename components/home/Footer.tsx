export default function Footer() {
  return (
    <footer className="bg-darkPurple text-cream border-t border-black/10">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="/menu/guadalajara" className="hover:text-yellow-500 transition-colors tap-target inline-flex items-center">
                  Guadalajara, Jalisco
                </a>
              </li>
              <li>
                <a href="/menu/colima" className="hover:text-yellow-500 transition-colors tap-target inline-flex items-center">
                  Colima, Colima
                </a>
              </li>
            </ul>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div>
                <a 
                  ...
                  className="hover:text-yellow-500 transition-colors font-medium tap-target inline-flex items-center"
                >
                  📱 +52 33 1512 6548
                </a>
              </div>
